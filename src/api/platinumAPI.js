...
export const PLATINUM_PRICES = '/api/platinum-prices';

export const PLATINUM_PRICES_EXTENDED = '/api/platinum-prices-extended';
...
export const PLATINUM_STOCK_DETAIL = `${BASE_URL}/api/platinum-stock-detail/`;
