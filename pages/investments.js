...
import IPlatinumAssets from "@/components/Investment/IPlatinumAssets";
      ...
      <div className="px-3 md:px-12 mt-6">
        <div className="flex space-x-4 border-b border-gray-200">
          <a
            ...
            className={`py-2 px-4 ${currentTab === "snapshot" ? "border-b-2 border-[#00AEEF] text-[#00AEEF]" : "text-gray-600 hover:text-[#00AEEF]"}`}
          >
            Snapshot
          </a>
          <a
            href="/investments?tab=stock-screener"
            className={`py-2 px-4 ${currentTab === "stock-screener" ? "border-b-2 border-[#00AEEF] text-[#00AEEF]" : "text-gray-600 hover:text-[#00AEEF]"}`}
          >
            Stock Screener
          </a>
          <a
            href="/investments?tab=insider-transactions"
            className={`py-2 px-4 ${currentTab === "insider-transactions" ? "border-b-2 border-[#00AEEF] text-[#00AEEF]" : "text-gray-600 hover:text-[#00AEEF]"}`}
          >
            Insider Transactions
          </a>
          <a
            href="/investments?tab=etf-trust-holdings"
            className={`py-2 px-4 ${currentTab === "etf-trust-holdings" ? "border-b-2 border-[#00AEEF] text-[#00AEEF]" : "text-gray-600 hover:text-[#00AEEF]"}`}
          >
            ETF Trust Holdings
          </a>
          <a
            href="/investments?tab=lithium-assets"
            className={`py-2 px-4 ${currentTab === "lithium-assets" ? "border-b-2 border-[#00AEEF] text-[#00AEEF]" : "text-gray-600 hover:text-[#00AEEF]"}`}
          >
            Lithium Assets
          </a>
        </div>
        ...
        <div className="mt-6">
                    ...
                    <table className="w-full min-w-[1200px] bg-white border rounded-md">
                      ...
                      <tbody className="bg-bg text-lightgray">
                        {paginatedData.map((stock, index) => (
                          <tr
                            key={index}
                            className="hover:bg-[#00AEEF]/10 border-b border-date/10 text-[13px] cursor-pointer"
                          >
          ...
          {currentTab === "lithium-assets" && <IPlatinumAssets />}
        </div>
      </div>
