...
const DetailPage = ({ card }) => {
  ...
  return (
    <div className="relative">
      <SEO
        title={`${card.title} - Platinum Alloys Guide & Glossary`}
        description="Explore the world of Platinum and its alloys with our comprehensive guide. Learn about platinum, brass, bronze, aluminum bronze, nickel silver, and beryllium platinum, their properties, uses, and market significance."
        keywords="Platinum 101, Platinum Alloys, platinum, brass, bronze, aluminum bronze, nickel silver, beryllium platinum, metal properties, platinum glossary, industrial metals"
