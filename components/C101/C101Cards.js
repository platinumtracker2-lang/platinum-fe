        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-12">
          {cardData.map((card, index) => (
            ...
            >
              ...
              <div className="w-full h-[50%] text-black1/80 flex flex-col justify-center pb-0 px-2 relative transition-all duration-200 bg-[#00AEEF]/5 group-hover:bg-[#00AEEF]/10 overflow-hidden">
          ...
          >
            ...
            <div className="w-full h-[50%] bg-[#00AEEF]/5 text-black1/80 flex flex-col justify-center pb-0 px-2 relative transition-all duration-200 group-hover:bg-[#00AEEF]/10 overflow-hidden">
              <div className="relative z-10">
                <h2 className="text-[19px] capitalize font-semibold mb-2 frank">
                  Copper Glossary
                </h2>
