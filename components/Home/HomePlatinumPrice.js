  ...
  useEffect(() => {
    const fetchPrices = async () => {
      try {
        ...
        // Sort data to ensure Platinum comes first
        const sortedData = data.sort((a, b) => {
          if (a.metal_name === "Platinum") return -1;
          if (b.metal_name === "Platinum") return 1;
          return 0;
        });
...
export default HomePlatinumPrice;