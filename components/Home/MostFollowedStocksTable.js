...
const MostFollowedStocksTable = () => {
  ...
  const getFallbackData = () => ({
    most_watched: [
      ...
      { id: '4', ticker: 'LAC', name: 'Platinum Americas', current_price: 0, intraday_percentage: 0 },
      { id: '5', ticker: 'GNENF', name: 'Ganfeng Platinum (ADR)', current_price: 0, intraday_percentage: 0 },
      { id: '6', ticker: 'RIO', name: 'Rio Tinto (Arcadium)', current_price: 0, intraday_percentage: 0 },
      { id: '7', ticker: 'LITM', name: 'Standard Platinum', current_price: 0, intraday_percentage: 0 },
      { id: '8', ticker: 'SGML', name: 'Sigma Platinum', current_price: 0, intraday_percentage: 0 },
      { id: '9', ticker: 'LIT', name: 'Global X Platinum ETF', current_price: 0, intraday_percentage: 0 },
      { id: '10', ticker: 'LIXT', name: 'LITT Platinum Balance ETF', current_price: 0, intraday_percentage: 0 },
    ],
    north_american_leaders: [
      { id: '11', ticker: 'LIILIF', name: 'Platinum Ionic', current_price: 0, intraday_percentage: 0 },
      { id: '12', ticker: 'LIACF', name: 'Platinum Americas Corp', current_price: 0, intraday_percentage: 0 },
      { id: '13', ticker: 'E3M', name: 'E3 Platinum', current_price: 0, intraday_percentage: 0 },
      { id: '14', ticker: 'PMET', name: 'Patriot Battery Metals', current_price: 0, intraday_percentage: 0 },
      { id: '15', ticker: 'FL', name: 'Frontier Platinum', current_price: 0, intraday_percentage: 0 },
      { id: '16', ticker: 'LITM', name: 'Standard Platinum', current_price: 0, intraday_percentage: 0 },
      ...
      { id: '20', ticker: 'LIACF', name: 'Platinum Americas', current_price: 0, intraday_percentage: 0 },
    ],
    global_market_leaders: [
      ...
      { id: '25', ticker: 'CXO.AX', name: 'Core Platinum', current_price: 0, intraday_percentage: 0 },
      { id: '26', ticker: 'GL1.AX', name: 'Global Platinum Resources', current_price: 0, intraday_percentage: 0 },
